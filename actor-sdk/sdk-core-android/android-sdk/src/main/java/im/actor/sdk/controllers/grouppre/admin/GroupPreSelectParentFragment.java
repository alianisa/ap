...
public class GroupPreSelectParentFragment extends SimpleDisplayListFragment<GroupPre, GrupoPreHolder> {
    ...
    public void onCreate(Bundle saveInstance) {
        ...
        setTitle(groupType == GroupType.CHANNEL ? im.actor.sdk.R.string.select_channel_parent : im.actor.sdk.R.string.select_group_parent);
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View res = inflate(inflater, container, im.actor.sdk.R.layout.fragment_group_pre_select_parent, displayList);
