...
public class RequestStartAnonymousAuth extends Request<ResponseAuth> {
    ...
    public RequestStartAnonymousAuth(@NotNull String name, int appId, @NotNull String apiKey, @NotNull byte[] deviceHash, @NotNull String deviceTitle, @NotNull String deviceIpAddress, @NotNull String deviceLocation, @NotNull String deviceOS, @Nullable String timeZone, @NotNull List<String> preferredLanguages) {
        this.name = name;
        this.appId = appId;
        this.apiKey = apiKey;
