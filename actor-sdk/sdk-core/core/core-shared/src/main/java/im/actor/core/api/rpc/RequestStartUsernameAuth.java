...
public class RequestStartUsernameAuth extends Request<ResponseStartUsernameAuth> {
    ...
    public RequestStartUsernameAuth(@NotNull String username, int appId, @NotNull String apiKey, @NotNull byte[] deviceHash, @NotNull String deviceTitle, @NotNull String deviceIpAddress, @NotNull String deviceLocation, @NotNull String deviceOS, @Nullable String timeZone, @NotNull List<String> preferredLanguages) {
