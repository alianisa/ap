...
public class RequestStartEmailAuth extends Request<ResponseStartEmailAuth> {
    ...
    public RequestStartEmailAuth(@NotNull String email, int appId, @NotNull String apiKey, @NotNull byte[] deviceHash, @NotNull String deviceTitle, @NotNull String deviceIpAddress, @NotNull String deviceLocation, @NotNull String deviceOS, @Nullable String timeZone, @NotNull List<String> preferredLanguages) {
        this.email = email;
        this.appId = appId;
        this.apiKey = apiKey;
