...
//
//@available(iOS 10.0, *)
//class CallKitProviderDelegate: UIViewController, CXProviderDelegate {
//    
...
//        
//        let configuration = CXProviderConfiguration(localizedName: "Alo")
...
//    }
//    
//    func call(_ call: ACCallVM, didFailWithError error: Error) {
...
//        AAAudioManager.sharedAudio().callStart(Actor.getCallWithCallId(self.callId), speaker: false)
//    }
//    
...
//        AAAudioManager.sharedAudio().callEnd(Actor.getCallWithCallId(self.callId), speaker: false)
//        
//        if (self.callInvite != nil && self.callInvite?.state == .pending) {
...
////            VoiceClient.sharedInstance().configureAudioSession()
//            AAAudioManager.sharedAudio().callAnswered(Actor.getCallWithCallId(self.callId), speaker: false)
//        }
//    }
//    
