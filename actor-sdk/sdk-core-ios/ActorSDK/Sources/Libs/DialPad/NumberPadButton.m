...
- (UILabel *)numberLabel {
    if (!_numberLabel) {
        ...
        _numberLabel.font = [UIFont systemFontOfSize:60];
...
- (UIColor *)textColor {
    if (!_textColor) {
        _textColor = [UIColor colorWithRed:0.33 green:0.17 blue:0.77 alpha:0.5];
    }
    return _textColor;
}
...
- (UIColor *)pressedColor {
    if (!_pressedColor) {
        _pressedColor = [[UIColor colorWithRed:0.33 green:0.17 blue:0.77 alpha:1.0] colorWithAlphaComponent:NumberPadButtonPressedAlpha];
    }
