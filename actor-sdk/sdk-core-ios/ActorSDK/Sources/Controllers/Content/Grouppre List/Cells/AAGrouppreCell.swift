...
final class AAGroupreCell: AATableViewCell, AABindedCell {
    
    fileprivate let binder = AABinder()
    
    // Binding data type
    public typealias BindData = ACGroupPre
    
    // Hight of cell
    open static func bindedCellHeight(_ table: AAManagedTable, item: ACGroupPre) -> CGFloat {
        return 76
    }
    ...
    fileprivate var bindedItem: ACGroupPre?
    ...
    public override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
        ...
        counterViewBg.image = counterBgImage
    ...
    open func bind(_ item: ACGroupPre, table: AAManagedTable, index: Int, totalCount: Int) {
...
private class AADialogCellConfig {
    ...
    init(item: ACGroupPre, isStatusVisible: Bool, titleWidth: CGFloat, contentWidth: CGFloat, typingText:String) {
        self.item = item
