//
//  AASimpleManagedSection.swift
//  ActorSDK
//
//  Created by Diego Ferreira da Silva on 18/01/2018.
//  Copyright © 2018 Steve Kite. All rights reserved.
//

import Foundation

open class AASimpleManagedSection {
...
public extension AASimpleManagedSection {
    
    public func binded<T>(_ closure: (_ r: AASimpleBindedRows<T>) -> ()) -> AASimpleBindedRows<T> where T: UITableViewCell, T: AABindedCell {
