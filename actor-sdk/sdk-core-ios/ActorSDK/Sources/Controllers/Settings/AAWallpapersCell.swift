...
open class AAWallpapersCell1: AATableViewCell {
...
open class AAWallpapersCell2: AATableViewCell {
    ...
    public override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        wallpapper1.clipsToBounds = true
        wallpapper1.contentMode = .scaleAspectFill
        wallpapper1.image = UIImage.bundled("bg_3_preview.jpg")!
        wallpapper1.viewDidTap = { [unowned self] () -> () in self.wallpapperDidTap?("bg_3.jpg") }
        
        wallpapper2.clipsToBounds = true
        wallpapper2.contentMode = .scaleAspectFill
        wallpapper2.image = UIImage.bundled("bg_4_preview.jpg")!
        wallpapper2.viewDidTap = { [unowned self] () -> () in self.wallpapperDidTap?("bg_4.jpg") }
        
        wallpapper3.clipsToBounds = true
        wallpapper3.contentMode = .scaleAspectFill
        wallpapper3.image = UIImage.bundled("bg_5_preview.jpg")!
        wallpapper3.viewDidTap = { [unowned self] () -> () in self.wallpapperDidTap?("bg_5.jpg") }
