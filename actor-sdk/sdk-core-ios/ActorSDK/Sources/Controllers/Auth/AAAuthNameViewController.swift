...
open class AAAuthNameViewController: AAAuthViewController {
    ...
    public init(transactionHash: String? = nil) {
        ...
        navigationItem.rightBarButtonItem = UIBarButtonItem(title: AALocalized("NavigationNext"), style: .plain, target: self, action: #selector(AAAuthNameViewController.nextDidTap))
    }
