...
@available(iOS 9.0, *)
@objc public protocol AAImagePickerDelegate {
    
    @objc optional func controllerWillEnlargePreview(_ controller: AAImagePicker)
    @objc optional func controllerDidEnlargePreview(_ controller: AAImagePicker)
    
    @objc optional func controller(_ controller: AAImagePicker, willSelectAsset asset: PHAsset)
    @objc optional func controller(_ controller: AAImagePicker, didSelectAsset asset: PHAsset)
    
    @objc optional func controller(_ controller: AAImagePicker, willDeselectAsset asset: PHAsset)
    @objc optional func controller(_ controller: AAImagePicker, didDeselectAsset asset: PHAsset)
    
}

@available(iOS 9.0, *)
open class AAImagePicker: UIViewController {
...
//    }()
    ...
    lazy var backgroundView: UIView = {
        ...
        view.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(SheetController.handleCancelAction)))
        
        return view
    }()
    
    open var delegate: AAImagePickerDelegate?
...
@available(iOS 9.0, *)
extension AAImagePicker: UICollectionViewDataSource {
...
@available(iOS 9.0, *)
extension AAImagePicker: UICollectionViewDelegate {
...
@available(iOS 9.0, *)
extension AAImagePicker: UICollectionViewDelegateFlowLayout {
...
@available(iOS 9.0, *)
extension AAImagePicker: UIViewControllerTransitioningDelegate {
