#import "AAAudioWaveformView.h"

#import "AAAudioWaveform.h"

//@interface AAAudioWaveformContentView : UIView
//
//@property (nonatomic, strong) UIColor *color;
//@property (nonatomic, strong) AAAudioWaveform *waveform;
//@property (nonatomic) CGFloat peakHeight;
//
//@end
//
//@implementation AAAudioWaveformContentView
//
...
//}
//
//- (void)setWaveform:(AAAudioWaveform *)waveform {
//    if (AAObjectCompare(_waveform, waveform)) {
//        return;
//    }
//    
//    _waveform = waveform;
...
//@end
//
//@interface AAAudioWaveformView () {
//    AAAudioWaveformContentView *_backgroundView;
//    UIView *_foregroundClippingView;
//    AAAudioWaveformContentView *_foregroundView;
//}
//
//@end
//
//@implementation AAAudioWaveformView
//
//- (instancetype)initWithFrame:(CGRect)frame {
//    self = [super initWithFrame:frame];
//    if (self != nil) {
//        _backgroundView = [[AAAudioWaveformContentView alloc] initWithFrame:self.bounds];
//        _foregroundView = [[AAAudioWaveformContentView alloc] initWithFrame:self.bounds];
